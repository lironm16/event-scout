...
const ACCESS_RULES = [
  ...
  // NOTE: seniors is NOT an access-restricted community. 60+ events are an
  // ordinary age audience (audience='ותיקים'); they are open to everyone and
  // surface only to users who selected ותיקים as a target audience. (We
  // removed the former community-seniors scope so they are no longer hidden.)
  {
