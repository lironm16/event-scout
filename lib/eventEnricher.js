...
function cheerioText($el) {
  ...
  // Insert newlines before block boundaries.
  clone.find("br").replaceWith("\n");
  clone.find("p, div, li, tr").each(function () {
    const el = cheerio.load(this)("*").first();
    // Append a newline after the element's own text.
    cheerio.load(this)(this).append("\n");
  });
  return clone
    .text()
...
function extractDescription(html) {
  ...
  const body = cleanDescription(cheerioText($("body")));
