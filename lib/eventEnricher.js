...
const RESPONSE_SCHEMA = {
  ...
  required: ["audience", "category", "tags", "min_months", "max_months", "age_range"],
};
...
14. החזירי JSON תקין בלבד. אל תוסיפי שדות מעבר ל-8 המפתחות. כל המפתחות חייבים להופיע — כולל age_range עם min ו-max (כל קצה הוא אובייקט או null; אסור להשמיט את max).`;
