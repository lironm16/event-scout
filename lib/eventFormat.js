...
function formatAudienceLine(event) {
  ...
  // Without a meaningful FLOOR (min null/0), an age range reads as "לידה עד X"
  // (from birth) / "עד X" — wrong for a ילדים/נוער/הורים event. Show the
  // audience label instead (e.g. ילדים). A real positive floor still renders a
  // range (e.g. "3-6") below.
