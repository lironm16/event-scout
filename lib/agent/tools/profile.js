    ...
    properties: {
      ...
      communities: {
        ...
        description:
          ...
          "'community-lgbtq', 'community-seniors'. Values: 'member' (include events for " +
          "this community in default search) or 'not-member' (exclude — and don't ask again). " +
          "Use 'null' as a value to clear a previously-set status. " +
          "Examples: " +
