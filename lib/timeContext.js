...
const ADMIN_NAME_PATTERNS = [
  ...
  // "טסט" is the Hebrew transliteration of "test" and never appears in a real
  // event title — treat like admin junk: filtered from results + purged in
  // cleanup. Plain substring so deleteAdminEntries' ILIKE %טסט% catches it.
  /טסט/i,
];
