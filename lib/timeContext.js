...
/**
 * True if the event occurred entirely before "now" in Israel time.
 * - date strictly < today → past.
 * - date === today AND start_time HH:MM < current time → past.
 * - everything else → not past.
 */
function isEventInPast(dateStr, startTime = null) {
