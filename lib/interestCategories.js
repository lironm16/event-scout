...
const AUDIENCE_CATEGORIES = [
  // Target-audience chips ARE the events.audience enum values verbatim, so a
  // selected chip maps 1:1 to the audience it shows. Multi-select; users pick
  // as many as they like. (Mirror of audience_t in sql/032+065+070.)
  { id: "תינוקות",     label: "תינוקות",     emoji: "👶" },
  { id: "ילדים",       label: "ילדים",       emoji: "🧒" },
  { id: "נוער",        label: "נוער",        emoji: "🎒" },
  { id: "מבוגרים",     label: "מבוגרים",     emoji: "🧑" },
  { id: "לכל המשפחה",  label: "לכל המשפחה",  emoji: "👨‍👩‍👧" },
  { id: "הורים",       label: "הורים",       emoji: "🤱" },
  { id: "ותיקים",      label: "ותיקים",      emoji: "🌷" },
  ...
  { id: "special",   label: "צרכים מיוחדים",      emoji: "🧩", community: "community-disabilities" },
