...
function searchGoLabel(gender) {
  return genderForm(gender, { f: "חפשי", m: "חפש", n: "חיפוש" });
}

function searchMarkVerb(gender) {
  return genderForm(gender, { f: "סמני", m: "סמן", n: "סמן/י" });
}

function tryAgainVerb(gender) {
  return genderForm(gender, { f: "נסי", m: "נסה", n: "נסה/י" });
}

function pickActionVerb(gender) {
  return genderForm(gender, { f: "בחרי", m: "בחר", n: "בחר/י" });
}
