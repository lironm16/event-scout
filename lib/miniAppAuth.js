...
const MAX_AGE_SECONDS = 24 * 60 * 60; // 24h — a Mini App stays open for hours;
// a 3h cap silently 401'd authed actions (save/suppress) on long sessions while
// cached reads still rendered, looking like "saving is broken".
