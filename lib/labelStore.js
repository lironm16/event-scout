...
// Strip a trailing 4-digit year from a label name so "שבועות 2026"
// normalises identically to "שבועות". City cluster names routinely
// append the current year as an editorial grouping hint (e.g.
// "שבועות 2026"), but from a user/tagging perspective these are the
// same concept as the base holiday/topic name. Without this, Gemini's
// semantic output ("שבועות") and the cluster name ("שבועות 2026")
// resolve to two different label rows, producing redundant tags.
