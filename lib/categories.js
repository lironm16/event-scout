...
// Strict 1:1 to the audience_t enum: searching an audience returns ONLY that
// audience (no implicit "לכל המשפחה" widening). Whoever searches ותיקים sees
// only ותיקים; whoever searches ילדים sees only ילדים. "לכל המשפחה" is its
// own searchable audience.
